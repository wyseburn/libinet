/**
 *  Version:     @(#)libinet/type_check.hxx    0.1.2 28/05/2008
...
namespace inet
{
    ...
    template <class Type> struct is_float { static const bool value = false; };
    template <> struct is_float<float> { static const bool value = true; };

    template <class Type> struct is_double { static const bool value = false; };
    ...
    struct is_std_set_container { static const bool value = false; }; 
    template <class Type> struct is_std_set_container<Type, 
    typename enableif<is_std_set<Type >::value || is_std_multiset<Type >::value>::type>
    { static const bool value = true; };
    ...
    template <class Type, class Enable = void>
    struct is_std_map_container { static const bool value = false; }; 
    template <class Type> struct is_std_map_container<Type, 
    typename enableif<is_std_map<Type >::value || is_std_multimap<Type >::value>::type>
    { static const bool value = true; };
    ...
    typename enableif<is_std_set_container<Type >::value || is_std_map_container<Type >::value>::type>
    { static const bool value = true; };
