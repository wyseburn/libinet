...
namespace inet
{
    struct msg_header
    {
        ...
        INET_S11N_2(msg_header, inet_int32, id_, inet_uint32, body_len_);
    };

    template <typename Type = void>
    struct msg_id
    {
        static const inet_int32 _msg_id = 0;
    };
} // namespace

#define INET_MESSAGE_1(msgid, classname, member1type, member1name)                           \
INET_S11N_TRAITS_1(classname, member1type, member1name)                                      \
namespace inet { template <> struct msg_id<classname > {static const inet_int32 _msg_id = msgid;};}
